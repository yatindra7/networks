...
int main () {
    ...
    printf("[LOG1] ALL DATA SENT, RECEIVING RESULT NOW\n");
    ...
    printf("[LOG2] ALL DATA SENT, RECEIVD RESULTS\n");
    ...
    //printf("[ANS] %s\n", answer);
    //uint32_t expr_val = ntohl(*((uint32_t *)answer));
    //double *final_ans = (double *) &answer;
